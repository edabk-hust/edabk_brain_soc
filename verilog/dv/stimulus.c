...
// FILE OUTPUT: 256x32 synapse_matrix of 5 cores. There are 256 * 5 = 1280 lines (each line has 32-bit)
...
// binaryParameters: [NUM_CORES][NEURON_PER_CORES][4]. Each neuron per core stores 16 bytes, divided into 4 array items, each packing 4-byte neuron params
...
// FILE OUTPUT: [NUM_CORES][NEURON_PER_CORES][4] => 5*32*4 = 640 lines, each line contains 4-byte (32-bit) of neuron parameter of a core
